...
public class Cell { //Classe qui impl�mente une cellule de matrice de l'agorithme des liens dansants

	public Cell U,D,L,R;
	public int row,col;
	
	public Cell(Cell R, Cell D,int row, int col){ // cr�e une nouvelle cellule � gauche de R et en haut de D
		if (R==null)
			this.R=this.L=this;
		else{
			this.R=R;
